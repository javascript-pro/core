...
export const analyse = (): any => async (dispatch: TUbereduxDispatch, getState: () => any) => {
  try {
    ...
    const response = await fetch('/api/cv/analyse', {
      method: 'POST',
    ...
    const [matchOverview, ...rest] = json.result.split('Optimized CV (Markdown)');
