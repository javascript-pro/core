Replacing Emotion with Pigment CSS eliminates ~15kB from the final bundle. Pigment CSS looks through Material UI components used in the project and extracts the styles into plain CSS. Material UI provides a set of layout components that integrate with Pigment CSS to support React Server Components.
